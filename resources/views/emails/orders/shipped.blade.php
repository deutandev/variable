...
We shipped your order at <strong>{{\General::datetimeFormat($order->shipment->shipped_at)}}</strong> and here is your tracking number: <strong>{{ $order->shipment->track_number }}</strong>
<br>
<br/>
