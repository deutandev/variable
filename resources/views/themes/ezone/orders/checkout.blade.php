						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="checkout-form-list">
									...
									{!! Form::text('address1', null, ['required' => true, 'placeholder' => 'Jl. Sana no78, Konosari']) !!}
								</div>
							</div>
							{{-- <div class="col-md-12">
								<div class="checkout-form-list">
							...
							<div class="col-md-12">
								<div class="checkout-form-list">
									...
									{!! Form::select('province_id', $provinces, Auth::user()->province_id, ['id' => 'province-id', 'placeholder' => '- Pilih - ', 'required' => true]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Kota/Kabupaten<span class="required">*</span></label>
									{!! Form::select('city_id', $cities, null, ['id' => 'city-id', 'placeholder' => '- Pilih -', 'required' => true])!!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
							...
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Telp./WA  <span class="required">*</span></label>										
									{!! Form::text('phone', null, ['required' => true, 'placeholder' => 'Telp./WA']) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
						...
						<div class="different-address">
							...
							<div id="ship-box-info">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="checkout-form-list">
											<label>Alamat <span class="required">*</span></label>
											{!! Form::text('shipping_address1', null, ['placeholder' => 'Jl. Kenangan No.7, Konoha RT03/RW06, Nogosari']) !!}
										</div>
									</div>
									{{-- <div class="col-md-12">
										<div class="checkout-form-list">
							...
							<div class="order-notes">
								<div class="checkout-form-list mrg-nn">
									...
									{!! Form::textarea('note', null, ['cols' => 30, 'rows' => 10,'placeholder' => 'Kalimat ucapan: "Happy Graduation", 
						...
						<div class="your-order-table table-responsive">
							<table>
								...
								<tbody>
									...
									@empty
										<tr>
											<td colspan="2">Keranjang masih kosong :) </td>
										</tr>
									@endforelse
								</tbody>
								<tfoot>
									...
									<tr class="cart-subtotal">
										<th>Ongkos Kirim ({{ $totalWeight }} kg)</th>
